...
func add_difficulty(id: String, copy_current := false) -> void:
	...
	if copy_current and not charts.is_empty():
		...
		data = {"format": "minghe-chart", "format_version": 1, "notes": [], "sections": [], "presentation": {"scene_id": "s02", "use_scene_show": false}, "timing": {"ppq": 480, "first_beat_offset_ms": 0, "chart_offset_ticks": 0, "end_tick": 7680, "tempo_events": [{"tick": 0, "bpm": 120}], "meter_events": [{"tick": 0, "numerator": 4, "denominator": 4}]}}
