...
static func object(kind: String, asset := "") -> Dictionary:
	var names := {"sprite": "精灵", "image": "HUD 图片", "animated_sprite": "动画精灵", "text": "HUD 文字", "actor": "BOSS", "group": "对象组", "environment": "环境", "camera": "镜头", "audio": "声音"}
	return {"id": id("object"), "name": names.get(kind, kind), "type": kind, "asset": asset, "animation": "", "parent_id": "", "layer": "hud" if kind in ["text", "image"] else "world", "depth": 0.0, "occlusion_depth": 0, "occlusion_order": "none", "locked": false, "hidden": false, "fields": {"position": [960.0, 540.0], "rotation": 0.0, "scale": [1.0, 1.0], "opacity": 1.0, "color": "ffffffff", "visible": true, "size": [560.0, 100.0], "text": "在此输入文字", "font_size": 36, "alignment": 1, "font": "", "visible_ratio": 1.0, "volume_db": 0.0, "zoom": 1.0, "shake": 0.0}}
